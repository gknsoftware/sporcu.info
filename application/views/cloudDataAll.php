				...
				<div class="row" style="padding-top: 10%">
					<div class="col-md-12">
						...
						<div class="form-group">
							<select class="form-group dataStudentList" name="studentList">
								<?php
						...
						<form class="cloudDataForm" action="<?php echo route('admin/addCloudData_JS/'); ?>" method="post" enctype="multipart/form-data">
